...
export default function DashboardProfilePlaceholder() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-[#0D0D0D]">
      <div className="border hairline bg-[#141414] p-10 max-w-md text-center rounded relative">
        ...
        <p className="text-white/55 text-sm leading-relaxed">
          The profile details editing tab is currently under development. Please use the Preview tab to review your generated developer report card.
        </p>
      </div>
    </div>
  );
